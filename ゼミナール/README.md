...
* 論理：**野矢茂樹『新版 論理トレーニング』（産業図書, 2006）** のすべての課題問題の解答を，全員で確認しながらMarkdown形式（1ファイル）で書き，ゼミ長がpull requestする。（複数人で一つのファイルを作る方法は全員で工夫すること。例：章ごとに担当者を決め，担当者が作った解答案を毎週全員で確認する。）
...
* **野矢茂樹『新版 論理トレーニング』（産業図書, 2006）** のすべての課題問題の解答（Markdown形式の1ファイル，フォルダ「ゼミナール/年度」に，ゼミ長がpull request）
