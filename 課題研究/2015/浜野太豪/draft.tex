...
本研究ではまず人狼知能プロジェクトから提供されている人狼サーバの起動を行う．開発言語はJava．開発環境はEclipseを用いた．人狼知能プロジェクトから提供された4種類のJarファイルをビルドパスに追加し，人狼サーバの起動を確認する．人狼エージェントのアルゴリズムを理解するためにサンプル人狼エージェントと第一回人狼知能大会の優勝プログラム饂飩エージェントのソースコードリーディングを行う．ソースコードリーディングの際にはJavaの本とクラス図を参考にして行う．
