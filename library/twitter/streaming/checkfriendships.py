...
reset = friendship['reset'] + 10

sys.stdout.write('echo "select retweet,retweeted from retweets where checked=FALSE limit %s;" | mysql -utest -ppass --skip-column-names twitter | python friendship.py | mysql -utest -ppass twitter\n' % apinum)
