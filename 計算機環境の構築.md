...
```
cinst -y chrome curl git github notepad2 r.project rsync sourcetree vagrant virtualbox visualstudiocode wget
```
...
パスワードは`C:\Users\<username>\.vagrant.d\boxes\ubuntu-VAGRANTSLASH-xenial64\20170427.0.0\virtualbox\Vagrantfile`に記載がある。
