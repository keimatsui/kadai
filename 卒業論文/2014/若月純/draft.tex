...
\section{目的}
GitHubを用いたソフトウェア開発プロジェクトの性質において，適切な開発フローを選択できる基準を提供する．
...
次に，調査したデータの分析をする．調査したデータをランダムに２種類のデータに分け，決定木分析を行う．決定木分析により，プロジェクトがどのような性質を持つときに，どの開発フローが使われているかを明らかにする．
