...
\item MediaWikiに知識を登録．
\item 登録した情報から，単語間の関連情報を抽出．
\item 抽出した情報を使って，用語の翻訳．
\end{enumerate}
