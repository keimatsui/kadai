...
\section{進捗状況}
矢吹研究室に所属する３年生の課題文を添削を数回行い，エラー数の推移をグラフ化した．エラー数が減った文書の修正推移を以下に記載する．

\begin{enumerate}
 \item 文書頭からマルまでの文字数を120字以内に収め，カンマと同一単語の複数回利用を抑えたことで文長が短くなった
 \item ですます調とである調の混在を修正し，である調に統一した
 \item 「一つ」，「1つ」と「結合システム」，「結合するシステム」等の数値と専門用語をひとつの表現に統一した
\end{enumerate}
