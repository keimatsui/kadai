...
\section{進捗状況}
矢吹研究室に所属する３年生の課題文を，文長に関する添削機能や，文書表現に関する機能を用いて添削した．
数値や専門用語の表現が統一されていない場合や，同一の単語や文が複数連続するとエラーを出力する設定を用い，図\ref{conf}の推移結果を得た．
...
エラー数が減っている文書は，添削結果の内容を修正したことから，マシンの検査をパスしていることがわかった．

一方，エラー数が減らない原因として，添削システムの設定が不十分なため，正しい文書添削をすることができなかった．
